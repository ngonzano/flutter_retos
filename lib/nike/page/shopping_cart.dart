...
class _ShoppingCartState extends State<ShoppingCart>
  ...
  Animation<double>? _animationOpcacidad;
  ...
  void initState() {
    ...
    _animationOpcacidad = Tween(begin: 1.0, end: 0.0).animate(
      CurvedAnimation(
        parent: _controller!,
    ...
    _animationMovementIn = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: _controller!,
        curve: const Interval(0.3, 0.75, curve: Curves.fastLinearToSlowEaseIn),
      ),
    );
                ...
                child: Stack(
                  children: [
                    ...
                    if (_animationMovementIn!.value != 1) ...[
                      Positioned(
                        ...
                        child: AnimatedOpacity(
                          ...
                          opacity: _animationOpcacidad!.value == 1 ? 1.0 : 0.0,
                    ...
                    Positioned(
                      ...
                      left: (size.width * 0.5 - panelSizeWidth * 0.5) +
                          (_animationResize!.value == 1 ? 20 : 0),
                      child: Hero(
                        tag: 'image_${widget.shoes.model}',
                        child: Transform.rotate(
                          angle: _animationResize!.value == 1
                              ? 0.0
                              : -1 + _animationResize!.value,
                          child: AnimatedOpacity(
                            duration: const Duration(milliseconds: 1700),
                            opacity: _animationOpcacidad!.value == 1 ? 1 : 0.0,
                            child: Image.asset(
                              widget.shoes.images!.first,
                              height: currentImageSize +
                                  (_animationResize!.value == 1 ? 0 : 20),
                            ),
                          ),
                        ),
                      ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ///never go away
                  // Transform.rotate(
                  //   angle: widget.animationResize.value == 1
                  //       ? 0
                  //       : -0.5 + widget.animationResize.value,
                  //   child: Image.asset(
                  //     widget.shoes.images!.first,
                  //     height: currentImageSize +
                  //         (widget.animationResize.value == 1 ? 0 : 30),
                  //   ),
                  // ),

                  /// animation starts at 1 and ends at 0
                  /// this block disappears when it is 1
